...
// //         className="fixed left-0 right-0 top-0 bottom-0 z-[1001] flex items-center justify-center h-96"
...
// //         className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-full text-base sm:text-lg md:text-xl font-semibold shadow-lg hover:bg-blue-700"
// //         onClick={(e) => {
// //           e.preventDefault();
...
//       <a
//         href="tel:+10865449042"
//         className="absolute bottom-6 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4  sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-full text-sm sm:text-lg md:text-xl font-semibold shadow-lg hover:bg-blue-700"
//         style={{
...
<div className="relative flex justify-center items-center">
      ...
      <a
        href="tel:+10865449042"
        className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-3  sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-full text-base sm:text-lg md:text-xl font-semibold shadow-lg hover:bg-blue-700"
        onClick={(e) => {
          e.preventDefault();
          // Trigger keyboard input for phone number
          window.location.href = "tel:+10865449042";
