...
<header className="w-full relative bg-gradient-to-r  text-white text-center py-16 overflow-hidden">
  ...
  <div className="relative z-10 max-w-4xl mx-auto px-4">
    ...
    <div className="mt-8 flex justify-center space-x-4">
      <a
        href="#support"
        className="inline-block bg-gray-700 text-white font-semibold py-3 px-6 rounded-full shadow-lg hover:bg-red-700 transition transform hover:scale-105"
      >
        Get Support
      </a>
      <a
  ...
  <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-transparent to-gray-900 opacity-20">
    <svg viewBox="0 0 1440 320">
      ...
      <nav className="bg-gradient-to-r bg-white to-indigo-600 text-white flex flex-wrap justify-center p-6 shadow-lg rounded-b-lg">
        <a
          href="#streaming"
          className="mx-4 my-2 px-4 py-3 bg-gray-800 rounded-lg transition-colors transform hover:scale-105 shadow-md"
        >
          Streaming Services
        </a>
        <a
