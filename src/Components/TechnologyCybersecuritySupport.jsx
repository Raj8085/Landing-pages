...
function TechnologyCybersecuritySupport() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      {/* Header */}
      <header className="relative bg-gradient-to-r from-gray-800 to-gray-900 text-center py-16 overflow-hidden">
            ...
            <form>
              <div className="mb-6">
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-3 border border-gray-700 rounded-lg bg-gray-700 text-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 transition"
              ...
              <div className="mb-6">
                <label htmlFor="query" className="block text-gray-900 font-medium mb-2">
                  Your Query:
                </label>
                <textarea
                  id="query"
